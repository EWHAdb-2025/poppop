...
/* 폐기물 종류 인덱스 (통계 집계용) */
CREATE INDEX DB2025_WASTE_EMAIL ON DB2025_WASTE(type);


/* 데이터 삽입 */
INSERT INTO DB2025_USER (id, name, role, email) 
VALUES (1, "김민지", "producer", "minji@example.com"), 
(2, "박서은", "processor", "seoun@example.com"), 
(3, "김정수", "manager", "jeongsu@example.com"), 
(4, "서현지", "producer", "hyeonji@example.com"),
(5, "김은빈", "manager", "eunbin@example.com"),
(6, "박은서", "producer", "eunseo@example.com"),
(7, "김지민", "producer", "jimin@example.com"),
(8, "서지현", "processor", "jihyeon@example.com"),
(9, "김수정", "manager", "sujeong@example.com"),
(10, "김은비", "producer", "eunbee@example.com");

INSERT INTO DB2025_COMPANY_INFO (id, user_id, business_number, company_name, representative_name, representative_phone, address) 
VALUES (1, 1, "204958329392", "맛있는쿠키", "김민지", "01000000000", "서울특별시 서대문구"), 
(2, 2, "204958329393", "서은클린", "박서은", "01000000001", "경기도 이천시"), 
(3, 4, "204958329394", "샤넬메이크업", "서현지", "01000000002", "대구광역시 수성구"), 
(4, 6, "204958329395", "향긋한커피", "박은서", "01000000003", "대전광역시 중구"), 
(5, 7, "204958329396", "디올코스매틱", "김지민", "01000000004", "제주특별자치도 서귀포시"),
(6, 8, "204958329397", "깨끗한처리", "서지현", "01000000005", "경상북도 안동군"),
(7, 10, "204958329398", "감자튀김킹", "김은비", "01000000006", "강원도 춘천시");

INSERT INTO DB2025_POPUP_MANAGEMENT(id, user_id, name, address, start_date, end_date)
VALUES (1, 1, "쿠키 신메뉴 시식전", "서울특별시 마포구 홍익로 23", '2025-05-01', '2025-05-03'),
(2, 3, "샤넬 메이크업 2025 F/W", "서울특별시 서대문구 연희로 45", '2025-04-09', '2025-04-30'),
(3, 6, "향긋한커피 원두 박람회", "부산광역시 해운대구 센텀중앙로 97", '2025-03-17', '2025-03-20'),
(4, 7, "디올리비에라", "인천광역시 남동구 인하로 100", '2025-06-03', '2025-06-04'),
(5, 10, "감튀월드", "대구광역시 중구 동성로 3길 15", '2025-07-01', '2025-07-03');

INSERT INTO DB2025_WASTE(id, amount, type)
VALUES (1, 5, "plastic"),
(2, 3, "paper"),
(3, 8, "metal"),
(4, 5, "glass"),
...
INSERT INTO DB2025_DISPOSAL_RECORD(id, user_id, popup_id, waste_id, status, disposal_date)
VALUES (1, 1, 1, 1, "pending", '2025-05-04'),
(2, 3, 2, 2, "processing", '2025-05-07'),
(3, 1, 1, 3, "completed", '2025-05-10'),
(4, 6, 3, 4, "cancelled", '2025-05-20'),
(5, 6, 3, 5, "processing", '2025-05-27');